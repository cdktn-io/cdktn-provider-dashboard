...
# CDKTN Prebuilt provider dashboard

[![Build / Refresh Status](https://github.com/cdktn-io/cdktn-provider-dashboard/actions/workflows/build.yml/badge.svg)](https://github.com/cdktn-io/cdktn-provider-dashboard/actions/workflows/build.yml)

This repo publishes the [CDKTN prebuilt provider dashboard](https://cdktn-io.github.io/cdktn-provider-dashboard/)

The dashboard is a static site written using [11ty](https://www.11ty.dev/) and Github actions that generates every hour (ideally) and fetches the status of all CDKTN pre-built providers and builds a simple dashboard for them.
...
Then point your browser to http://localhost:8080/cdktn-provider-dashboard/
